...
export default function DropConnection({ connection }: Props) {
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <Dialog.Panel className='mx-auto max-w-xl bg-white rounded px-5'>
                        <div className='py-5'>
                            ...
                            <Dialog.Description>
                                <span>
                                    Deleting connection <strong className='text-sm'>{connection.name}</strong>
                                </span>
                            </Dialog.Description>
                        </div>
                        ...
                        <p className='font-sans'>
                            ...
                            Created backups on this connection will be permanently
                        ...
                        <div className='py-5 flex gap-x-2'>
                            <button
                                ...
                                onClick={() => {
                                    Inertia.delete(route('connection.delete', { id: connection.id }), {
                                        onBefore: () => {
                                            setProcessing(true)
                                        },
                                        onFinish: () => {
